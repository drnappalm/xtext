/**
 */
package org.mph.plc.st.sTLanguage.util;
...
public class STLanguageAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected STLanguageSwitch<Adapter> modelSwitch =
    new STLanguageSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter casePOU_BODY(POU_BODY object)
      {
        return createPOU_BODYAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.mph.plc.st.sTLanguage.POU <em>POU</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.mph.plc.st.sTLanguage.POU_BODY <em>POU BODY</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createPOU_BODYAdapter()
  {
    return null;
  }
