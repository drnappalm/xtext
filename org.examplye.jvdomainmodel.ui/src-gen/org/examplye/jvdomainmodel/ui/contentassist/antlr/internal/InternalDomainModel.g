...
:
(
{ before(grammarAccess.getModelAccess().getInmportsSectionAssignment_0()); }
(rule__Model__InmportsSectionAssignment_0)?
{ after(grammarAccess.getModelAccess().getInmportsSectionAssignment_0()); }
)
...
:
(
{ before(grammarAccess.getModelAccess().getInmportsSectionXImportSectionParserRuleCall_0_0()); }
	ruleXImportSection{ after(grammarAccess.getModelAccess().getInmportsSectionXImportSectionParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getModelAccess().getElementsAbstractElementParserRuleCall_1_0()); }
	ruleAbstractElement{ after(grammarAccess.getModelAccess().getElementsAbstractElementParserRuleCall_1_0()); }
)
